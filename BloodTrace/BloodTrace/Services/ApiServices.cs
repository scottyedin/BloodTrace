...
namespace BloodTrace.Services
{
    public class ApiServices
    {
        public async Task<bool> RegisterUser(string email, string password, string confirmPassword)
        {
            ...
            var response = await httpClient.PostAsync("http://bloodtraceapptest.azurewebsites.net/api/Account/Register", content);
        ...
        public async Task<bool> LoginUser(string email, string password)
        {
            ...
            var request = new HttpRequestMessage(HttpMethod.Post, "http://bloodtraceapptest.azurewebsites.net/Token");
